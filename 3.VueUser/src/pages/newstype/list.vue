...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","top":"130px","flexWrap":"wrap","left":"0","background":"transparent","display":"flex","width":"20%","position":"absolute","height":"auto"}'>
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#000","display":"inline-block"}'>分类名称：</div>
	  ...
	  <el-button v-if="btnAuth('newstype','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"20px 10px 0 0","outline":"none","color":"#fff","borderRadius":"60px","background":"#313131","width":"auto","fontSize":"15px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/newstypeAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"16px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
