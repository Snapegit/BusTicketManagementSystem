...
<div :style='{"width":"68%","padding":"80px 0","margin":"10px auto","position":"relative","background":"transparent"}'>
    ...
    <div v-if="storeupType==1" class="section-title" :style='{"margin":"10px 0 0","color":"#fff","textAlign":"center","background":"#000","width":"100%","fontSize":"20px","lineHeight":"2"}'>我的收藏</div>
