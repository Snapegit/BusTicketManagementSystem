    ...
    <div v-if="!showFlag" style="width: 100%;">
      <div>
        <el-table
          ...
          style="width: 100%;"
        >
          <el-table-column :resizable='false' :sortable='true' prop="ask" :formatter="askFormat" header-align="center" align="center" sortable label="新消息"></el-table-column>
          <el-table-column
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"4px","outline":"none","color":"#fff","borderRadius":"4px","background":"rgba(44, 55, 66, 0.9)","width":"auto","fontSize":"14px","height":"32px"}'
                size="small"
